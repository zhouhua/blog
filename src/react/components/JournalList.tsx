    ...
    item.type === 'year'
      ...
      : (
          <div
            className={cn(
              'colorModeTransition',
              'mx-auto mb-16 w-full max-w-[820px] overflow-hidden rounded-[28px] border border-solid border-secondary/10 bg-card',
            )}
          ...
          >
            <div className="colorModeTransition flex sm:flex-row items-end justify-between gap-6 border-b border-solid border-secondary/10 px-10 pb-5 pt-7 flex-col sm:items-start sm:gap-3 sm:px-5 sm:pb-4 sm:pt-5 md:px-8">
              <a
                className="colorModeTransition font-monospace text-[26px] font-semibold leading-none tracking-[0.08em] no-underline"
